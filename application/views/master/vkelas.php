          ...
          <tbody>
              <?php 
                ...
                foreach ($data->result() as $row) {
                    ?>
            <tr>
              <td class="checkbox-column text-center"> <?php echo $row->id_kelas; ?> </td>
              ...
              <td class="text-center">
                <ul class="table-controls">
                  ...
                  <li>
                    <a href="javascript:void(0);" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Eye">Detail</a>
                  </li>
                  <li>
